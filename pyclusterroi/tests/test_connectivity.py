...
class TestConnectivity(TestCase):
    ...
    def test_make_ones_parcellation(self):
        ...
        for participant in [1]:
            ...
            ret_val = pc.make_individual_parcellation(range(10, 100, 10), 'ones', None, gm_mask_file,
    ...
    def test_make_tcorr_parcellation(self):
        ...
        for participant in [1]:
            ...
            ret_val = pc.make_individual_parcellation(range(10, 100, 10), 'tcorr', participant_input_data, gm_mask_file,
                                                      participant_output_prefix, thresh=0.5)
